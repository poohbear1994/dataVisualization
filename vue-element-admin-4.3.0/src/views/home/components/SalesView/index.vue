 ...
 * @LastEditTime: 2021-07-18 15:09:47
      ...
      <template v-slot:header>
        <div class="menu-wrapper">
          ...
          <div class="menu-right">
            ...
            <el-date-picker v-model="date" class="sales-view-date-picker" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" :unlink-panels="true" />
          </div>
        </div>
      </template>
